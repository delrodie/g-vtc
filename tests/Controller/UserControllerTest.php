...
final class UserControllerTest extends WebTestCase
{
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            ...
            'user[connexion]' => 'Testing',
            'user[lastConnectedAt]' => 'Testing',
        ]);
    ...
    public function testShow(): void
    {
        ...
        $fixture->setLastConnectedAt('My Title');
    ...
    public function testEdit(): void
    {
        ...
        $fixture->setConnexion('Value');
        $fixture->setLastConnectedAt('Value');
        ...
        $this->client->submitForm('Update', [
            ...
            'user[connexion]' => 'Something New',
            'user[lastConnectedAt]' => 'Something New',
        ]);
        ...
        self::assertSame('Something New', $fixture[0]->getLastConnectedAt());
    }
